...
| FWD-01b | Remaining 14 templates, financials first. **Held** until FWD-07 shows what parses for a bank/insurer/REIT. Output *shapes* for all 16 already ship in `OUTPUT_KINDS` — this row is the driver sets only. | _unassigned_ (Gemini off roster) | BLOCKED (on FWD-07) |
